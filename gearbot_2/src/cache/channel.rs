...
impl Channel {
    pub fn from_guild_channel(channel: GuildChannel) -> Self {
        match channel {
            ...
            GuildChannel::NewsThread(thread) =>
                Channel {
            ...
            GuildChannel::PrivateThread(thread) =>
                Channel {
                    channel_type: ChannelType::GuildPrivateThread,
                    permission_overwrites: Vec::new(),
                    name: thread.name,
            ...
            GuildChannel::PublicThread(thread) =>
                Channel {
                    channel_type: ChannelType::GuildPrivateThread,
                    permission_overwrites: Vec::new(),
                    name: thread.name,
...
impl Cache {
    pub fn insert_channel(&self, guild_id: GuildId, channel_id: ChannelId, channel: Arc<Channel>) -> Option<Arc<Channel>> {
